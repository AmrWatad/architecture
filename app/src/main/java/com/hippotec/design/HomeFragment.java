...
public class HomeFragment extends AppCompatActivity implements RecyclerViewAdapter.ItemListener {
    @Override
  ...
  /*  RecyclerView recyclerView;
    ...
    public void onItemClick(DataModel item) {
        ...
        *//*Intent i = new Intent(getApplicationContext(), ViewPhoto.class);
        ...
        bundle.putString("item", String.valueOf(item));
        i.putExtras(bundle);
        startActivity(i);*//*
    }*/
}
